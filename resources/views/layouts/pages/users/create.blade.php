            ...
            <form action="/users/store" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="name" class="form-control" id="name" placeholder="Masukan nama" name="name" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="role" name="role" placeholder="Pilih Role">
