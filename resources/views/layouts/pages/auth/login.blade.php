...
<head>
    ...
    <title>Simpel Unisa - Login</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <!-- Kolom Gambar Logo -->
                            <div class="col-lg-6 d-flex align-items-center justify-content-center bg-login-image" style="padding-top: 15px;">
                                <img src="{{ asset('templates/img/logo.png') }}" alt="Logo" class="img-fluid" style="max-width: 250px;">
                            </div>
