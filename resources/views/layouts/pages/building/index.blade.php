...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="h3 mb-2 text-gray-800">Jenis Gedung</h1>
            </div>
            <div class="col-sm-6 ml-auto text-right">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                    <li class="breadcrumb-item active">Jenis Gedung</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card shadow mb-5">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Tabel Jenis Gedung</h6>
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#createModal">
                            Tambah Gedung
                        </button>
                        <!-- Modal Create-->
                        @include('layouts.pages.building.create')
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="table-Categori">
                                ...
                                <tbody>
                                    @foreach ($buildings as $item)
                                        <tr>
                                            <td class="text-center">{{ isset($buildings) && method_exists($buildings, 'currentPage') ? ($buildings->currentPage() - 1) * $buildings->perPage() + $loop->iteration : $loop->iteration }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <!-- Modal Edit-->
                                                    @include('layouts.pages.building.edit')
