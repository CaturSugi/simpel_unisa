...
class Trash3Chart
{
    ...
    {
        $trashes = Trash::where('category_id', 3)->get(); // Assuming category_id 2 is for plastic
        ...
        return $this->chart3->areaChart()
            ->setTitle('Sampah Basah.')
            ->setSubtitle('')
            ->addData('Berat Sampah Basah (kg)', $formattedData)
            ->setXAxis($months);
    }
}
